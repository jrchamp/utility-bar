(function(w,d,undefined){
	...
	var _ub = w._ub || {},
		...
		barPlaceholder = d.getElementById('ncstate-utility-bar'),
	...
	bar.innerHTML = ''
		...
		+ '<div class="ncstate-utility-bar-links is-hidden">'
			+ '<div class="ncstate-utility-bar-wrapper">'
				+ '<ul class="ncstate-utility-bar-primary-util' +(_ub.showBrick==1?" accomodate-brick":"") + '">'
	...
	if (barPlaceholder && barPlaceholder.parentNode == documentBody) {
